...
@Singleton
@Component(modules = [AppModule::class, StorageModule::class, NetworkModule::class, PlaygroundModule::class, PlaygroundBindModule::class, UserModule::class, UserBindModule::class])
